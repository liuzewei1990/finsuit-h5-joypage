...
// 分享成功领取奖励
export const getShareLottery = (params, head) => http.post(config.baseUrlHost, config.baseUrlPath, "COLLAGE_CLUB_GET_REWARD", params, head, false, false, "分享成功领取奖励")
// 活动是否开启
export const getActivityFlag = (params, head) => http.post(config.baseUrlHost, config.baseUrlPath, "COLLAGE_CLUB_MAIN_PAGE", params, head, false, false, "活动是否开启")
