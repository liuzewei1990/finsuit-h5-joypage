...
// 获取比财专属福利列表
export const getExcWelfareData = (params, head) => http.post(config.baseUrlHost, config.baseUrlPath, "NEW_EXCLUSIVE_BENEFITS", params, head, false, false)

// 获取拼财专属福利列表
export const getpcExcWelfareData = (params, head) => http.post(config.baseUrlHost, config.baseUrlPath, "PC_NEW_EXCLUSIVE_BENEFITS", params, head, false, false)
