        ...
        <div class="TOPIC-LOTTERY-OPEN">
          ...
          <div class="lottery-item">
            <cro>
              ...
              <span class="coupon-content ellipsis">{{content.couponTitle}}</span>
              <a class="coupon-btn" v-show="contentText" href="javascript:void(0);" @click="contentCallBack" v-track:ACB0I005.click="()=>{}">{{contentText}}</a>
            </cro>
    ...
    <template v-if="type == 'ACCOUNT-RULE'">
      <dialog-common-box>
        <div class="ACCOUNT-RULE">
          <h5>{{title}}</h5>
          <div class="content common-rich-max-img" v-html="content"></div>
        </div>
      </dialog-common-box>
    </template>
