  ...
  <div class="one-topic-radio">
    ...
    <template v-if="isHaveTopic === true">
      ...
      <div class="footer">
        ...
        <EllipsisText v-if="disabledBtn === true && topicDescTextIsShow===true && topicDescText" :text="topicDescText" clamp="2" v-track:ACB0I007.click.native="()=>{}"></EllipsisText>
      </div>
    </template>
...
<script>
import { Checker, CheckerItem } from "@topic/components/Checker";
import EllipsisText from "@topic/components/EllipsisText"
...
.checker-item-disabled {
  border: 3px solid #3887fe;
  box-shadow: 0px 5px 8px #cfdefd;
  background: #fff;
  .item {
    .title {
      color: #3887fe;
