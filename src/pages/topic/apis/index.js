...
// 获取每日一题活动信息
export const getTopicInfo = (params, head) => http.post(config.baseUrlHost, config.baseUrlPath, "GET_ACTIVITY_QUESTION_DATA", params, head, false, false, "获取每日一题活动信息")
...
// 查询是否已经活体
export const getFaceDiscernStatus = (params, head) => http.post(config.baseUrlHost, config.baseUrlPath, "GET_AUTH_STATUS_V2", params, head, false, false)
