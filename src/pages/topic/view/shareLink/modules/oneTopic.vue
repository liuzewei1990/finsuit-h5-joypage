<template>
  <div class="share-oneTopic">
    ...
    <!-- 每日一题->题目 -->
    <calendar v-show="bjImgSrc" :isRadius="true" class="mar-top">
      <topic ref="topic" :isHaveTopic="isHaveTopic" :topicTitle="topicTitle" :topicDescText="topicDescText" :topicOptions="topicOptions" @btnConfirm="$checkLogin({action:btnConfirm})" :isShare="isShare"></topic>
    </calendar>
  </div>
</template>
...
import Topic from "@topic/components/Topic/shareTopic.vue"
export default {
