...
//获取定期活动首页数据
export const getRegularData = (params, head) => http.post(config.baseUrlHost, config.baseUrlPath, "FIXED_DEPOSIT_PRODUCT", params, head, false, false)

//获取定期活动列表数据
export const getRecordData = (params, head) => http.post(config.baseUrlHost, config.baseUrlPath, "FIXED_DEPOSIT_INFO", params, head, false, false)

//切换地图显示
export const getSwitchData = (params, head) => http.post(config.baseUrlHost, config.baseUrlPath, "FIXED_DEPOSIT_POPUP", params, head, false, false)
