...
//2020-5-6新增
// 活动icon
export const PCM000A005 = (params) => http.postPoint(config.baseUrlHost, config.baseUrlPath, { ...params, FUNCTION_ID: "PCM000A005", REMARK_DATA: "首页-关注" });
// 首页-您的额外收益
export const PCB000A191 = (params) => http.postPoint(config.baseUrlHost, config.baseUrlPath, { ...params, FUNCTION_ID: "PCB000A191", REMARK_DATA: "首页-您的额外收益" });
 ...
 */
// 首页-横版banner
export const PCB000A190 = (params) => http.postPoint(config.baseUrlHost, config.baseUrlPath, { ...params, FUNCTION_ID: "PCB000A190", REMARK_DATA: "首页-横版banner" });
// 首页-tab键
export const PCB000A486 = (params) => http.postPoint(config.baseUrlHost, config.baseUrlPath, { ...params, FUNCTION_ID: "PCB000A486", REMARK_DATA: "首页-tab键" });
// 首页优选-安全购买区域
export const PCB000A487 = (params) => http.postPoint(config.baseUrlHost, config.baseUrlPath, { ...params, FUNCTION_ID: "PCB000A487", REMARK_DATA: "首页优选-安全购买区域" });
// 首页-人数拼团更多按钮
export const PCB000A488 = (params) => http.postPoint(config.baseUrlHost, config.baseUrlPath, { ...params, FUNCTION_ID: "PCB000A488", REMARK_DATA: "首页-人数拼团更多按钮" });
// 首页-金额拼团更多按钮
export const PCB000A489 = (params) => http.postPoint(config.baseUrlHost, config.baseUrlPath, { ...params, FUNCTION_ID: "PCB000A489", REMARK_DATA: "首页-金额拼团更多按钮" });