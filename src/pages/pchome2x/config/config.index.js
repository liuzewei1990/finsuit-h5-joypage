...
const CONFIG = {
    ...
    development: {
        ...
        // baseUrlHost: "http://easy-mock.liuup.com/mock/5de0e4390a2f9f42cfec19c4/pchome",
        // api path
        ...
        // 拼团活动
        teamItemUrl: "http://192.168.137.1:8080/teamItem2x.html",
        // 拼人数活动
        prsItemUrl: "http://192.168.137.1:8080/prsItem2x.html",
        // 比财零花钱页面地址
    ...
    productionTest: {
        ...
        // 拼团活动
        teamItemUrl: (window.location.protocol + '//' + window.location.host) + "/activity/teamItem2x/index.html",
        // 拼人数活动
        prsItemUrl: (window.location.protocol + '//' + window.location.host) + "/activity/prsItem2x/index.html",
        // 比财零花钱页面地址
