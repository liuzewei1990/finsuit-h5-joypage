  ...
  <div class="alone-producd-min">
    <div class="boxList">
      <section class="sectionLeft">
        ...
        <!-- 利率+加息 -->
        <RateTemplate align="left" :rateData="$handlePrdRate.handleRateAndCouponRate(item.prdRate,item.couponType,item.couponRate,item.couponAmount)" :prdRateText="item.prdRateText"></RateTemplate>
      </section>
