  ...
  <div class="team-producd" ref="team-producd">
    ...
    <div class="item">
      ...
      <div class="footer">
        ...
        <Button class="btn" :showLoading="false" type="default" :disabled="false" v-if="item.START_STATUS == '1' && item.IS_REMIND == '0'" @click.native.stop="$checkLogin({action:handleClickReminBtn,data:item})">{{btnText[$store.state.APP_FLAG] || '立即预约'}}</Button>
