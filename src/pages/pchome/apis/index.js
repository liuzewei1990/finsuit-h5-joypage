...
// 获取拼财首页拼团列表 --- 世帅新版接口
export const getHomeTeamList = (params, head) => http.post(config.baseUrlHost, config.baseUrlPath, "GET_ACT_TEAM_MAIN_PAGE_INFO", params, head, false, false, "获取拼财首页拼团列表")

// 获取拼团时间轴列表，拼财比财通用接口
export const getTeamDateList = (params, head) => http.post(config.baseUrlHost, config.baseUrlPath, "GET_ACT_TEAM_MORE_AND_PERIOD", params, head, false, false, "获取拼团时间轴列表，拼财比财通用接口")
...
// 获取拼人数列表3.0
export const getPersonDataNew = (params, head) => http.post(config.baseUrlHost, config.baseUrlPath, "GET_ASSEMBLE_PERSON_MAIN_PAGE_NEW", params, head, false, false, "获取拼人数列表3.0")
